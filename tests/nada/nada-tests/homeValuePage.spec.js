...
test('@regression @TC-NADA-23 @TC-NADA-24 @TC-NADA-31 verify placeholder text of all the text fields in home value page', async ({ page }) => {
    ...
    await homeValuePage.selectPropertyTypeSingleFamilyHome();
